...
const NAV: NavItem[] = [
  ...
  },
  {
    to: "/global-network",
    ko: "운송/창고",
    en: "Transport/Warehouse",
    sub: [
      { to: "/global-network", ko: "내륙 운송", en: "Inland Transport" },
      { to: "/global-network", ko: "창고 (일반/특수)", en: "Warehousing" },
      { to: "/global-network", ko: "특수화물", en: "Special Cargo" },
    ],
  },
  {
    to: "/trade-solutions",
