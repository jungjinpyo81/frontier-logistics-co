...
import { ArrowRight, ArrowUpRight, Boxes, ShieldCheck, Globe2, TrendingUp, BookOpen, Newspaper, Mail } from "lucide-react";
...
const CTA_CARDS = [
  { to: "/services", icon: Boxes, label: "Services", ko: "서비스", desc: "Ocean, air, express & inland" },
  { to: "/special-cargo", icon: ShieldCheck, label: "Special Cargo", ko: "특수화물", desc: "Dangerous, cold chain, project" },
